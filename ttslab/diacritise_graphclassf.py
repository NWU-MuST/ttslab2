...
import ttslab.diacritise as diacritise
...
class GraphClassifDiacritiser(diacritise.Diacritiser):
...
if __name__ == "__main__":
    import random
    import ttslab.diacritise_graphclassf 
    ...
    d = ttslab.diacritise_graphclassf.GraphClassifDiacritiser(langdescr["graphs"],
                                                              langdescr["vowels"],
