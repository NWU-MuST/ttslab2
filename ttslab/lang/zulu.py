...
class Phoneset(ttslab.phoneset.Phoneset):
    ...
    def __init__(self):
        ...
        self.phones = {"pau"    : set(["pause"]),
                       ...
                       "d͡ʒ"     : set(["class_consonantal", "consonant", "manner_affricate", "pl_palatal", "place_alveolar", "place_post-alveolar", "voiced"]),
                       ...
                       "ǀ"      : set(["class_consonantal", "consonant", "manner_click", "place_dental", "pl_alveolar"]),
                       ...
                       "ǀʰ"     : set(["class_consonantal", "consonant", "manner_click", "place_dental", "pl_alveolar", "aspirated"]),
                       ...
                       "ɡ͡ǀ"      : set(["class_consonantal", "consonant", "manner_click", "pl_velar", "place_dental", "voiced"]),
                       "l"      : set(["class_sonorant", "class_consonantal", "manner_approximant", "manner_liquid", "manner_lateral", "place_alveolar", "voiced"]),
                       "ɡ͡ǃ"      : set(["class_consonantal", "consonant", "manner_click", "pl_velar", "place_post-alveolar", "voiced"]),
                       ...
                       "ɡ͡ǁ"      : set(["class_consonantal", "consonant", "manner_click", "manner_lateral", "pl_velar", "place_alveolar", "voiced"]),
