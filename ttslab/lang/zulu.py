...
class Phoneset(ttslab.phoneset.Phoneset):
    ...
    def __init__(self):
        ...
        self.phones = {"pau"    : set(["pause"]),
                       ...
                       "d͡ʒ"     : set(["class_consonantal", "consonant", "manner_affricate", "place_palatal", "place_alveolar", "place_post-alveolar", "voiced"]),
                       ...
                       "ǀ"      : set(["class_consonantal", "consonant", "manner_click", "place_dental", "place_alveolar"]),
                       ...
                       "ǀʰ"     : set(["class_consonantal", "consonant", "manner_click", "place_dental", "place_alveolar", "aspirated"]),
