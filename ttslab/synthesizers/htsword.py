...
from ttslab.synthesizers.hts_labels_word import * #all feature funcs (p, a, b, ...) and htk number conversion
from ttslab.synthesizers.htsengine_me_cffi import HTS_EngineME

class Synthesizer(ttslab.synthesizers.hts.Synthesizer):
    """Simple HTS synthesizer implementation with "standard" labels up to
       word context (excluding phrase and sentence context). We use
       the modified HTS engine which is capable of mixed excitation
       synthesis.
    """
